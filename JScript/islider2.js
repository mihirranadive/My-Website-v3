...
(function () {
    ...
    function ISMSlider(options) {
        ...
        var default_options = {
            ...
            opts, ol, slide_width_pc, slide_index, first_slide, last_slide,
        ...
        function init_config(given_opts) {
            ...
            for (p in default_options) {
                type = typeof default_options[p];
                if (given_opts[p] == undefined && type != "object") {
                    data_value = $(".ism-slider").data(p);
        ...
        function init_buttons() {
            ...
            if (opts.buttons) {
                var buttons_html = "<div class='ism-button ism-button-prev'>&nbsp;</div>" + "<div class='ism-button ism-button-next'>&nbsp;</div>";
        ...
        function init_radios() {
            ...
            if (opts.radios) {
                ...
                for (var i = 0; i < get_slide_count(); i++) {
                    if (i == 0) {
                        radios.append("<li class='ism-radio-" + i + " active'>" + "<input type='radio' name='ism-radio' class='ism-radio' id='ism-radio-" + i + "' checked='checked' />" + "<label class='ism-radio-label' for='ism-radio-" + i + "'></label>" + "</li>");
                    } else {
                        radios.append("<li class='ism-radio-" + i + "'>" + "<input type='radio' name='ism-radio' class='ism-radio' id='ism-radio-" + i + "' />" + "<label class='ism-radio-label' for='ism-radio-" + i + "'></label>" + "</li>");
                    }
                }
